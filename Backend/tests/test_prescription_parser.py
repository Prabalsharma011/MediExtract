...
def test_get_addresss(doc_1_maria,doc_2_virat,doc_3_empty):
...
def test_get_directions(doc_1_maria,doc_2_virat,doc_3_empty):
   # assert doc_1_maria.get_field('directions') == 'Prednisone, Taper 5 mig every 3 days, Finish in 2.5 weeks aLialda - take 2 pill everyday for 1 month'
...
def test_get_refills(doc_1_maria,doc_2_virat,doc_3_empty):
    assert doc_1_maria.get_field('refills') == '2 times'
    assert doc_2_virat.get_field('refills') == '3 times'
...
def test_parse(doc_1_maria,doc_2_virat,doc_3_empty):
    ...
    assert record_maria['refills'] == '2 times'
